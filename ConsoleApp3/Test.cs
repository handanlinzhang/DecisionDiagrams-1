...
namespace ConsoleApp3
{
    class Test<T> where T : IDDNode
    {
        ...
        public void BaseInitialize()
        {
            ...
            this.Va = this.Manager.CreateBool(0.1);
            this.Vb = this.Manager.CreateBool(0.1);
            this.Vc = this.Manager.CreateBool(0.1);
            this.Vd = this.Manager.CreateBool(0.1);
            ...
            for (int i = 0; i < 4; i++)
            {
                var v = this.Manager.CreateBool(0.1);
        ...
        */
        ...
        public void TestSatisfiabilityException1()
        {
            ...
            assignment.Get(this.Manager.CreateBool(0.1));
        }
        ...
        public void TestTableResize()
        {
            ...
            var v = manager.CreateBool(0.1);
            var w = manager.CreateBool(0.1);
            var x = manager.CreateBool(0.1);
            var y = manager.CreateBool(0.1);
            var z = manager.CreateBool(0.1);
        ...
        public void TestWrongManagerOperation()
        {
            ...
            var x = manager1.CreateBool(0.1);
            var y = manager2.CreateBool(0.1);
        ...
        public void TestNumBits()
        {
            ...
            Assert.AreEqual(1, manager.CreateBool(0.1).NumBits);
        ...
        public void TestExistsEarlyCutoff()
        {
            ...
            {
                var manager = new DDManager<T>(this.Factory, 8, 8, true);
                var a = manager.CreateBool(0.1);
                var b = manager.CreateBool(0.1);
                var c = manager.CreateBool(0.1);
                var d = manager.CreateBool(0.1);
        ...
        public void TestReplaceAllVariables()
        {
            if (QuantifiersSupported)
            {
                ...
                var c = manager.CreateBool(0.1);
                var d = manager.CreateBool(0.1);
                var e = manager.CreateBool(0.1);
                var f = manager.CreateBool(0.1);
